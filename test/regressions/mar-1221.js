...
async function createOfferEthSell(
  contract,
  amountAlice,
  tokenBob,
  amountBob,
...
describe('MAR-1221', () => {
  ...
  it('should migrate contracts with minimumSize ETH offer', async () => {
    let { owner, alice, bob, charlie, dex, usdt, MarsBase } =
      await prepareEnvironment();

    await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000',
  ...
  it('should migrate contracts after several ETH offers', async () => {
    ...
    let offer0 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000'
    ...
    let offer1 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000'
    ...
    let offer2 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000'
    ...
    let offer3 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000'
    ...
    let offer4 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000'
    ...
    let offer5 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000',
    ...
    let offer6 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000',
    ...
    let offer7 = await createOfferEthSell(
      dex.connect(alice),
      '200000000000000000',
      usdt.address,
      '62232606000000000000',
