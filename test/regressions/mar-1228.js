...
describe("MAR-1228", () => 
{
    ...
    {
		let { owner, alice, bob, charlie, dex, usdt, bat, MarsBase } = await prepareEnvironment()
		...
		let offer = await createOfferTokenToken(
			dex.connect(alice),
			bat.address, offerData.amountAlice,
			usdt.address, offerData.amountBob[0], {
