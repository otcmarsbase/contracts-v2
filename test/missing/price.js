...
describe("missing/price", () => 
{
    it("should correctly calculate price for small amounts", async () =>
    {
		...
		{
			let price = await dex.price(amountAlice, offerAmountAlice, offerAmountBob)
			// console.log(`${amountAlice} ${amountBob} = ${price}`)
			expect(await dex.price(amountAlice, offerAmountAlice, offerAmountBob)).equal(amountBob)
		}
	})
	it("should correctly calculate price for small fractional amounts", async () =>
	{
		...
		for (let [amountAlice, amountBob] of [
			...
			[5, 2],
			[10, 5],
			["1999982931186871361193477570619256", "999991465593435680596738785309628"],
			["1999982931186871361193477570619255", "999991465593435680596738785309627"],
		])
		{
			let price = await dex.price(amountAlice, offerAmountAlice, offerAmountBob)
			// console.log(`${amountAlice} ${amountBob} = ${price}`)
	...
	it("should correctly calculate price for big alice and small bob", async () =>
	{
		...
		])
		{
			let price = await dex.price(amountAlice, offerAmountAlice, offerAmountBob)
			// console.log(`${amountAlice} ${amountBob} = ${price}`)
			expect(await dex.price(amountAlice, offerAmountAlice, offerAmountBob), `${amountAlice} ${amountBob} = ${price}`).equal(amountBob)
		}
	...
	it("should correctly calculate price for equally small alice and bob", async () =>
	{
		...
		for (let [amountAlice, amountBob] of [
			...
			["999991465593435680596738785309628", "999991465593435680596738785309628"],
			["1999982931186871361193477570619256", "1999982931186871361193477570619256"],
		])
		{
			let price = await dex.price(amountAlice, offerAmountAlice, offerAmountBob)
			// console.log(`${amountAlice} ${amountBob} = ${price}`)
	...
	it("should correctly calculate price for big alice and bob (a < b)", async () =>
	{
		...
		for (let [amountAlice, amountBob] of [
			...
			["999991465593435680596738785309628", "1999982931186871361193477570619256"],
			["999991465593435680596738785309627", "1999982931186871361193477570619254"],
		])
		{
			let price = await dex.price(amountAlice, offerAmountAlice, offerAmountBob)
			// console.log(`${amountAlice} ${amountBob} = ${price}`)
