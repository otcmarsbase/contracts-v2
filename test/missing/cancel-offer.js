...
describe('cancel static offers', () => {
  ...
  it('should cancel static offers after some bids were made but not enough', async () => {
    ...
    let txBid = await dex
      .connect(bob)
      .acceptOffer(offer.id, bat.address, bobAmountBid);
    await txBid.wait();
  ...
  it(
    'should cancel static offers after some bids were made with 0 minimumSize'
  );
});
