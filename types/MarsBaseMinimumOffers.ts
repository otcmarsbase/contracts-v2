...
export interface MarsBaseMinimumOffersInterface extends utils.Interface {
  contractName: "MarsBaseMinimumOffers";
  functions: {
...
export interface MarsBaseMinimumOffers extends BaseContract {
  contractName: "MarsBaseMinimumOffers";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MarsBaseMinimumOffersInterface;
