...
export interface MockMarsBaseOffersInterface extends utils.Interface {
  contractName: "MockMarsBaseOffers";
  functions: {
    "_mock_setBlockTimeStamp(uint256)": FunctionFragment;
    "acceptOffer(uint256,address,uint256,address)": FunctionFragment;
    "acceptOfferPart(uint256,address,uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "acceptOfferPart",
    values: [BigNumberish, string, BigNumberish, string]
  ): string;
  encodeFunctionData(
...
export interface MockMarsBaseOffers extends BaseContract {
  contractName: "MockMarsBaseOffers";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMarsBaseOffersInterface;
