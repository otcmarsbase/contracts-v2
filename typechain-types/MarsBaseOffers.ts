...
export interface MarsBaseOffersInterface extends utils.Interface {
  contractName: "MarsBaseOffers";
  functions: {
...
export interface MarsBaseOffers extends BaseContract {
  contractName: "MarsBaseOffers";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MarsBaseOffersInterface;
