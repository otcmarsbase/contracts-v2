...
export interface MockMarsBaseMinimumOffersInterface extends utils.Interface {
  contractName: "MockMarsBaseMinimumOffers";
  functions: {
    "_mock_setBlockTimeStamp(uint256)": FunctionFragment;
    "acceptOfferPartWithMinimum(uint256,address,uint256,address)": FunctionFragment;
    "cancelBid(uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "acceptOfferPartWithMinimum",
...
export interface MockMarsBaseMinimumOffers extends BaseContract {
  contractName: "MockMarsBaseMinimumOffers";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockMarsBaseMinimumOffersInterface;
